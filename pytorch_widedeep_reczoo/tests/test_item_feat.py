...
def test_compute_features(sample_data):
    ...
    assert item_id_101_features["most_common_occupation"].values[0] == "student"
    assert item_id_101_features["most_common_zipcode"].values[0] == "12345"
    assert item_id_101_features["most_common_age"].values[0] == 25
...
def test_demographic_modes(sample_data):
    ...
    # Check demographic modes for item 101
    assert item_id_101_features["most_common_occupation"].values[0] == "student"
    assert item_id_101_features["most_common_zipcode"].values[0] == "12345"
    assert item_id_101_features["most_common_age"].values[0] == 25
