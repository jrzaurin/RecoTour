...
for udf in [ts_train_udf, train_df]:
    ...
    for user in random_users:
        ...
        num_ratings_fs = udf[udf["user_id"] == user]["total_ratings"].values[0]
...
for idf in [ts_train_idf, train_df]:
    for item in random_items:
        ...
        nunique_users_fs = idf[idf["item_id"] == item]["unique_reviewers"].values[0]
        ...
        top_occupations_fs = sorted(
            idf[idf["item_id"] == item][occupation_columns].values[0]
        )
        ...
        top_ages_fs = sorted(idf[idf["item_id"] == item][age_columns].values[0])
        ...
        n_male_viewers_fs = idf[idf["item_id"] == item]["male_viewers"].values[0]
        n_female_viewers_fs = idf[idf["item_id"] == item]["female_viewers"].values[0]
