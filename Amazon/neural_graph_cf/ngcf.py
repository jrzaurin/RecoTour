...
class NGCF_BPR(nn.Module):
    def __init__(self, n_users, n_items, emb_dim, adjacency_matrix, layers, node_dropout,
        ...
        # node_dropout will be used for both _node_dropout_sparse and
        # _edge_dropout_sparse
        ...
        # the embeddings could also be defined simply as tensors (a matter of choice):
        ...
        # it does not matter how we initialise these, the weights will be
        # replaced every forward pass
    ...
    def _edge_dropout_sparse(self, X, keep_prob):
        """
        Drop individual locations (edges) in the adjancency matrix
        """
    ...
    def _node_dropout_sparse(self, X, keep_prob):
        """
        Drop entire rows (nodes) in the adjancency matrix
        """
