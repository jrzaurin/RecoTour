...
def user_features(inp_dir, out_dir):
	...
	# Interactions
	df_visits_train = pd.read_pickle(os.path.join(inp_dir, 'ftrain', 'df_visits_train.p'))
	df_purchases_train = pd.read_pickle(os.path.join(inp_dir, 'ftrain', 'df_purchases_train.p'))

	# User features
	df_users_train = pd.read_pickle(os.path.join(inp_dir, 'ftrain', 'df_users_train.p'))

	# train coupons features
	df_coupon_train = pd.read_pickle(os.path.join(inp_dir, 'ftrain', 'df_coupons_train_feat.p'))
	...
	df_user_feat.to_pickle(os.path.join(out_dir,"ftrain","df_user_train_feat.p"))
